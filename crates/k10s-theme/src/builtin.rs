...
pub static K10S_DARK: LazyLock<Theme> = LazyLock::new(|| Theme {
    ...
    map: MapTheme {
        ...
        wl_icon: 0xb3adcf,
        hover_ring: 0x8470ff,
        selection_ring: 0xececef,
        // Brighter than the labels below it, because a namespace name is set at
        // display size and is the map's wayfinding: it is read from across the
        // island, not scanned. It also has to clear 4.5:1 on the warm heat stop,
        // which the previous value did by 0.27 -- lifting the island surfaces at
        // all took it under, and the audit said so before anything shipped.
        region_label: 0xc9c4e4,
        ...
        heat_fill: [0x22332b, 0x574620, 0x59262e],
